...
const roleRules = computed(() => [validators.required, () => !form.errors.role || form.errors.role]);
...
<template>
  ...
  <v-expand-transition>
    <v-dialog v-slot="{ isActive }" v-model="formDialog" :activator="activator" max-width="800">
      <v-card>
