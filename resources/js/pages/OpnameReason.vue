...
<template>
  ...
  <v-container>
    <v-row>
      <v-col>
        <PageTitleHighlightPart first-part-title="Kelola" second-part-title="Sebab Opname" />
      </v-col>
    </v-row>
    <v-row>
      <v-col>
                ...
                <td class="flex cursor-pointer items-center justify-end">
                  ...
                  <v-menu activator="parent" close-on-content-click>
                    <v-list density="compact" class="py-0!" :elevation="1">
                      <OpnameReasonEditVListItem :reason="opnameReason.reason" :opname-reason-id="opnameReason.id" />
