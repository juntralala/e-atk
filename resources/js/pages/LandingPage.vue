  ...
  <div>
    ...
    <section class="hero-section">
      <div class="hero-background">
        <v-img src="/storage/images/depan-igd-rsud-haji-darlan-ismail.webp" cover class="hero-image">
      ...
      <v-container class="hero-content">
        <v-row align="center" justify="center">
          <v-col cols="12" class="text-center">
            <v-img :src="settings.icon" height="300" class="mx-auto mb-6" />
            ...
            <v-card elevation="3" class="rounded-lg">
              <v-card-text class="pa-8">
                <p class="text-justify text-sm leading-relaxed text-gray-700 md:text-lg">
                  Kegiatan utama RSUD Haji Darlan Ismail adalah usaha pelayanan kesehatan perorangan dengan pendekatan
                  pelayanan medis, tindakan medik dan keperawatan, pelayanan penunjang medik, dan upaya rujukan. Dengan
                  core bisnis adalah pelayanan medis. Dalam upaya menghadapi persaingan global, terutama terhadap
                  kompetitor layanan sejenis di Kabupaten Tanah Laut, RSUD Haji Darlan Ismail berusaha memenangkan
                  persaingan dengan cara menjaga mutu layanan, Leader, SDM dan Sarana Prasarana, serta terjangkau oleh
                  semua lapisan masyarakat. Dengan berbekal sumber daya yang ada, didukung dengan pelayanan PONEK
                  diharapkan mampu mengundang minat masyarakat baik di wilayah Kabupaten Tanah Laut atau di luar wilayah
            ...
            <v-card class="h-full" elevation="2">
              ...
              <v-card-text class="pa-6">
                <ol class="space-y-3 text-sm! md:text-lg!">
                  <li v-for="(item, index) in settings.misi" :key="index" class="flex">
    ...
    <section class="bg-white py-16">
      <v-container>
        ...
        <v-row justify="center">
          <v-col cols="12" md="10" lg="9" class="pa-0">
            <v-card elevation="3" class="rounded-lg">
        ...
        <v-row>
          <v-col v-for="(stakeholder, index) in stakeholders" :key="index" cols="12" sm="6" md="3">
            <v-card
              ...
              elevation="2">
              <v-card-text class="pa-6">
                <v-avatar size="80" class="mb-4 bg-blue-700">
                  <v-icon size="50">
                    {{ stakeholder.icon }}
                  </v-icon>
                </v-avatar>
    ...
    <section class="bg-white py-16">
      <v-container>
        ...
        <v-row class="justify-center!">
          <v-col v-for="user of petugasUsers" :key="user.id" cols="12" sm="6" md="4" lg="3">
            <v-card
              class="h-full text-center transition-all! ease-in-out hover:-translate-y-2 hover:shadow-xl hover:delay-100! hover:duration-150!"
              elevation="2">
              <v-card-text class="pa-6">
                <v-avatar size="120" class="mb-4">
                  <v-img
                    ...
                    <template v-slot:placeholder>
                      <v-icon size="80" color="grey-lighten-2">mdi-account-circle</v-icon>
                    </template>
                  </v-img>
                </v-avatar>
                ...
                <div class="text-left">
                  <div class="mb-3 flex items-center justify-center gap-2">
                    ...
                    <a :href="`tel:${user.telepon}`" class="text-gray-700 transition-colors hover:text-blue-700">
                      {{ user.telepon }}
                    </a>
                  </div>
